...
<p align="center" class="footer"><a href="http://www.softbb.net"><span class="footer">[ Copyright SoftBB v0.1 ]</span></a> , [ Par Atapi ] , [ <?php echo $requse; ?> Requ&ecirc;te<?php if($requse > 1) echo 's'; ?> mysql utilisée<?php if($requse > 1) echo 's'; ?> ] , [ GZIP <?php if($gzip) echo 'activé'; else echo 'désactivé'; ?> ] <?php
$mtime = explode(" ",microtime());
